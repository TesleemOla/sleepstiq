...
const OurAmazingStory = () => {
  return (
    <div className="mt-10 w-5/6 sm:w-auto sm:pl-40 flex flex-wrap-reverse mx-2 mx-auto justify-center gap-5">
        ...
        <CardWrapper className=" w-5/6 h-2/3 sm:w-1/3 sm:h-1/4">
